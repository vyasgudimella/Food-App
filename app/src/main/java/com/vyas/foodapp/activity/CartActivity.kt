...
import com.vyas.foodapp.adapter.CartRecyclerAdapter
import com.vyas.foodapp.adapter.DescriptionRecyclerAdapter
...
class CartActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if(intent != null){
            ...
            recyclerAdapter = CartRecyclerAdapter(this, orderList as ArrayList<Dish>)
